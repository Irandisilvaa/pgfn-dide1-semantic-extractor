...
Write-Host "=== DIDE1 v3.3 / NOVO LOTE DE 100 ==="
Write-Host "Inicio na linha Excel: $StartExcelRow"
Write-Host "Protecoes v3.3: pedido, historico, citacao externa, ID numerico e prazo orfao."
...
& $PythonExe -m src.annotation.export_teacher_xlsx `
  ...
  --limit 100 `
  --output runtime/private_annotations/teacher_review_v33_next100.xlsx `
  --checkpoint runtime/private_annotations/teacher_v33_next100_checkpoint.json
